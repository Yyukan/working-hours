...
@implementation WorkingHoursAppDelegate
...
{
    EntityListController *entityListController = (EntityListController *)self.navigationController.topViewController;
